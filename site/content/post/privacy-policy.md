...
Our geolocation data is not connected to personal identifiers: meaning, we do not know the identity of a visitor. We sometimes use geolocation data to display special offers and discounts to any visitors who access the site from, or near, the zip code of 10022 where the Company provides its services. For example, in December 2018 and January 2019 we ran a discounted offer of 20% off, which was only visible to Site visitors accessing the Site from within -- or near -- the 10022 zip code (in Manhattan).
